/*:
 ...
 2- **Input Size:** The notation usually expresses complexity in terms of the size of the input (denoted as "n") to the algorithm, emphasising how the algorithm scales as the input grows.
 
 3- **Asymptotic Behaviour:** It focuses on the behaviour of an algorithm on the [asymptotic limit](Asymptotic%20Limit)
 */
